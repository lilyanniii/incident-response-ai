...
#need to store incident data generated by generate
#incident function into the vector db

if __name__ == "__main__":
    print(store_incidents_in_db())
    #function to take input from user
    # get_similar_incidents(user_query)
